...
export const NavItems = ({ items, className, onItemClick }: NavItemsProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "absolute inset-0 hidden flex-1 flex-row items-center justify-center space-x-2 font-medium  transition duration-200  md:flex lg:space-x-2",
        className
      )}
    >
      {items.map((item, idx) => (
...
export const MobileNav = ({ children, className, visible }: MobileNavProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-50  flex  max-w-[calc(100vw-2rem)] flex-col items-center justify-between bg-transparent  p-2 md:hidden rounded-full",
        visible && "bg-background/70",
        className
      )}
    >
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className={cn(
            "absolute inset-x-0 top-[82px] z-50 flex w-full flex-col items-center justify-center gap-4 rounded-lg bg-background/70 px-4 py-8 shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] ",
            className
          )}
        >
          {children}
